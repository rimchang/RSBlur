...
parser.add_argument('--gt_root', type=str, default='/Kiwi/Data1/Dataset/BSD_ESTRNN')
...
if __name__ == '__main__':
  ...
  for inp_path in path_list:
    ...
    gt_path = os.path.join(args.gt_root, 'BSD', 'BSD_'+inp_path_split[1], 'test', inp_path_split[2], 'Sharp', 'RGB', inp_path_split[-1])
